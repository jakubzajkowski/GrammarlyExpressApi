...
const TextTranslateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
        ...
        const promptGrammar = `You will be provided with statements, Your task is to translate this sentence in html brackets to ${language} do not change html brackets`;
            ...
            if ((user === null || user === void 0 ? void 0 : user.plan) == 'free') {
                if (user.prompts <= 1000) {
                    if (text) {
                        ...
                        return res.json({ success: { text: (_a = responseGrammar.choices[0].message) === null || _a === void 0 ? void 0 : _a.content } });
                    }
                    else {
            ...
            if ((user === null || user === void 0 ? void 0 : user.plan) == 'premium') {
                if (user.prompts <= 10000) {
                    if (text) {
                        ...
                        return res.json({ success: { text: (_b = responseGrammar.choices[0].message) === null || _b === void 0 ? void 0 : _b.content } });
                    }
                    else {
                        return res.json({ error: 'No content' });
                    }
            ...
            if ((user === null || user === void 0 ? void 0 : user.plan) == 'buisness') {
                if (user.prompts <= 20000) {
                    if (text) {
                        ...
                        return res.json({ success: { text: (_c = responseGrammar.choices[0].message) === null || _c === void 0 ? void 0 : _c.content } });
                    }
                    else {
                        return res.json({ error: 'No content' });
                    }
...
exports.default = TextTranslateController;
